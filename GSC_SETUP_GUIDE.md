...
This guide will help you set up **live Google Search Console (GSC)** integration for flywithwegofares.com. Once configured, you'll get **real-time data** from Google Search Console directly in your admin dashboard.
...
3. Enter your website: `https://flywithwegofares.com`
...
4. **Add Authorized Redirect URIs**
   ...
   **For Production (VPS):**
   ```
   https://flywithwegofares.com/api/gsc/oauth2callback
...
2. **Add Google Credentials**
   ...
   GSC_SITE_URL=https://flywithwegofares.com
...
3. **For Production VPS, use production URL:**
   ```env
   GOOGLE_REDIRECT_URI=https://flywithwegofares.com/api/gsc/oauth2callback
   ```
...
3. Check that the site URL in GSC matches exactly: `https://flywithwegofares.com`
...
2. **Add Production URI to Google Cloud**
   ...
   - Add `https://flywithwegofares.com/api/gsc/oauth2callback`
...
**4. Test Connection:**
- Go to: https://flywithwegofares.com/admin/dashboard
- Click SEO tab
