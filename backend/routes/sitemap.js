...
router.get('/sitemap.xml', (req, res) => {
  ...
  const baseUrl = process.env.SITE_URL || 'https://flywithwegofares.com';
...
<head>
  ...
  <title>Sitemap - flywithwegofares.com</title>
  <style>
...
<body>
  <div class="container">
    <h1>🗺️ Site Map</h1>
    <p class="subtitle">Complete navigation of flywithwegofares.com</p>
