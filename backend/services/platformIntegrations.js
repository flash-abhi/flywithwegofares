...
class PlatformIntegrations {
  ...
  async submitToDirectory(directoryUrl, businessInfo) {
    ...
    const defaultInfo = {
      businessName: process.env.SITE_NAME || 'WeGo Fares',
      website: process.env.SITE_URL || 'https://flywithwegofares.com',
      description: 'Best flight deals, hotels, cruises, and vacation packages. Save up to 70% on travel.',
      category: 'Travel',
      email: process.env.CONTACT_EMAIL || 'info@flywithwegofares.com',
