...
class RealBacklinkService {
  constructor() {
    this.siteUrl = process.env.SITE_URL || 'https://flywithwegofares.com';
    this.siteName = process.env.SITE_NAME || 'WeGo Fares';
    this.siteEmail = process.env.SITE_EMAIL || 'info@flywithwegofares.com';
  ...
  async submitToMix(pageData) {
    ...
    return {
      ...
      instructions: `
        ...
        5. Add title: ${pageData.title || 'Best Flight Deals - WeGo Fares'}
