...
function AdminDashboard() {
  ...
  const [siteSettingsData, setSiteSettingsData] = useState({
    ...
    tfn: '+1-866-699-8687',
    email: 'info@flywithwegofares.com',
    ...
    copyrightText: '© 2006-{year} WeGo Fares. All rights reserved.',
    ...
    siteUrl: 'https://flywithwegofares.com'
  });
  ...
  useEffect(() => {
    const fetchSeoToolData = async () => {
      ...
      if (activeSeoTool === 'backlinks' && seoToolData.backlinks.total === 0) {
        try {
          const response = await fetch(`${API_URL}/api/seo/backlinks?domain=flywithwegofares.com`, {
            headers: { 'Authorization': `Bearer ${token}` }
          });
          if (response.ok) {
            const data = await response.json();
  ...
  const handleGenerateSingleBlog = async () => {
    ...
    try {
      ...
      if (data.success) {
        const blogUrl = data.url || `https://flywithwegofares.com/blog/${data.post.slug}`;
    ...
    try {
      ...
      if (data.success) {
        const blogUrls = data.posts ? data.posts.map(post => 
          `https://flywithwegofares.com/blog/${post.slug}`
        ).join('\n') : '';
                    ...
                    <div className="connect-card">
                      ...
                      <form className="gsc-settings-form" onSubmit={async (e) => {
                        ...
                        <div className="form-group">
                          ...
                          <input
                            type="url"
                            name="siteUrl"
                            placeholder="https://flywithwegofares.com"
                            defaultValue="https://flywithwegofares.com"
                            required
                          />
                        </div>
                      ...
                      <div className="gsc-help-text">
                        ...
                        <ol>
                          ...
                          <li>Add redirect URI: <code>https://flywithwegofares.com/api/gsc/oauth2callback</code></li>
            ...
            <form onSubmit={handleSEOUpdate} className="seo-form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Best Flight Deals | WeGo Fares"
                />
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="https://flywithwegofares.com/og-image.jpg"
                />
              </div>
            ...
            <form onSubmit={handleContentUpdate} className="content-form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="info@flywithwegofares.com"
                />
              </div>
                        ...
                        <div className="post-details">
                          ...
                          {post.slug && (
                            <div className="blog-url">
                              <a href={`https://flywithwegofares.com/blog/${post.slug}`} target="_blank" rel="noopener noreferrer" className="url-link">
                                📍 flywithwegofares.com/blog/{post.slug}
                              </a>
                              <button 
                                onClick={() => {
                                  const url = `https://flywithwegofares.com/blog/${post.slug}`;
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group full-width">
                    ...
                    <input
                      ...
                      placeholder="© 2006-{year} WeGo Fares. All rights reserved."
                    />
