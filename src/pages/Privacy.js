      ...
      <div className="container">
        <div className="legal-content">
          <section>
            ...
            <p>At flywithwegofares.com, we collect the following types of information:</p>
            <ul>
          ...
          <section>
            ...
            <p>To exercise these rights, contact us at privacy@flywithwegofares.com</p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>Email: privacy@flywithwegofares.com</li>
              <li>Phone: {contactSettings.tfn}</li>
              <li>Mail: Privacy Department, flywithwegofares.com</li>
            </ul>
          </section>
        </div>
      </div>
